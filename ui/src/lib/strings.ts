...
export type Strings = {
  ...
  scopeReviewView: {
    ...
    selectAll: string;
    deselectAll: string;
    noFormsOrInputs: string;
    endpointsHeading: string;
    approveAndContinue: (count: number) => string;
    approvalSent: string;
    couldNotApprove: (detail: string) => string;
    unknownError: string;
  };
