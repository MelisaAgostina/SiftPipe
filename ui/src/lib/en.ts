...
export const en: Strings = {
  ...
  findingRow: {
    ...
    severityStatLabel: "Severity",
    typeStatLabel: "Type",
    scoreStatLabel: "Score",
    confidenceStatLabel: "Confidence",
    matchRationaleToggle: "Match rationale",
  },
  pastRunsView: {
  ...
  secPipelineApp: {
    ...
    pipelineFinishedToast: "Pipeline finished, results available in Past Runs tab",
  },
  landing: {
