...
export const en: Strings = {
  ...
  scopeReviewView: {
    pausedForReview:
      "This is a newly discovered target — nobody has reviewed what its login can reach yet. Check the pages that are safe to analyze further; anything left unchecked is dropped before any attack step ever runs.",
    noPagesYet: "No pages discovered yet.",
    selectedCount: (selected, total) => `${selected} of ${total} pages selected`,
    selectAll: "Select all",
    deselectAll: "Deselect all",
    noFormsOrInputs: "No forms or inputs found on this page",
    endpointsHeading: "Other endpoints seen (informational only)",
    approveAndContinue: (count) => `Approve ${count} page(s) and continue`,
    approvalSent: "Scope approved — continuing to payload generation",
    couldNotApprove: (detail) => `Could not approve: ${detail}`,
    unknownError: "unknown error",
  },
  discoverTargetDialog: {
    triggerButton: "Add new target",
    title: "Discover a new target",
    stepOf: (step, total) => `Step ${step} of ${total}`,
    stepIdentity: "What is the name of the target?",
    stepLocation: "Where does the target live?",
    stepCredentials: "How to access the target",
    nameLabel: "Target name",
    namePlaceholder: "e.g. juiceshop",
    invalidName: "Lowercase letters, digits, underscores, and hyphens only.",
    nameChecking: "Checking…",
    nameAvailable: "Available",
    nameTaken: "A target with this name already exists.",
    baseUrlLabel: "Base URL",
    baseUrlHelper: "The base URL plus the login path is the page SiftPipe opens first.",
    loginPathLabel: "Login path",
    invalidUrl: "Enter a full URL with no path here, e.g. http://localhost:3000",
    invalidLoginPath: "Login path should start with /, e.g. /login",
    credentialsHelper:
      "Name the two environment variables that hold the credentials. You'll never type a password here — SiftPipe reads the value straight from your own .env file.",
    usernameEnvLabel: "Username variable",
    passwordEnvLabel: "Password variable",
    invalidEnvVarName: "Variable names can only use A-Z, 0-9, and underscores.",
    envVarChecking: "Checking…",
    envVarPresent: "Found in your environment",
    envVarMissing: "Not set in your .env yet — add it there before running the pipeline.",
    back: "Back",
    next: "Next",
    cancel: "Cancel",
    startDiscovery: "Start discovery",
    runningTitle: "Reaching the login page…",
    runningBody:
      "Credentials are read directly from your environment — SiftPipe never sees the value.",
    couldNotStart: (detail) => `Could not start discovery: ${detail}`,
    successTitle: (name) => `${name} discovered`,
    loginSucceeded: "Login succeeded. It's now selectable from the target picker.",
    loginFailed: (error) =>
      `Login didn't succeed: ${error}. The target file was still saved — you can fix the login page or credentials and try again under a new name.`,
    selectorsFoundHeading: "Selectors found",
